   ...
   // private OrganizationDirectory directory;
    ...
    private void populateCombo(){
        organizationJComboBox.removeAllItems();
         ...
         {   
            ...
            if (type.getValue().equals(Type.ProductCompaniesSelection.getValue()) || type.getValue().equals(Type.PublishersManagement.getValue()) 
                    || type.getValue().equals(Type.AdexchangeFinanceOrganization.getValue()))
         ...
         {  
             for (Type type : Organization.Type.values()){
            if (type.getValue().equals(Type.FinanceOrganization.getValue()) || type.getValue().equals(Type.ManageProducts.getValue()) || type.getValue().equals(Type.ProductCompanyBidViewerOrganization.getValue()))
                organizationJComboBox.addItem(type);
            }
         } 
        else
         {
             for (Type type : Organization.Type.values()){
            if (type.getValue().equals(Type.PublisherSales.getValue()) || type.getValue().equals(Type.AdInventoryManagementOrganization.getValue()) ||type.getValue().equals(Type.CustomerOrganization.getValue()))
                organizationJComboBox.addItem(type);
            }
         }
    }  
    ...
    private void populateTable(){
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()){
            ...
            System.out.println("Organization is popped up here");
